...
| **C-3** | **`decide()` (T018) needs only T007 + T008.** No grammar, no measurement code, no fixtures — the six rules *read* an observed `MeasureAttempt`, they never produce one | [research.md](../specs/001-cross-exam-evaluator/research.md) D-06 | The verdict lane opens during the Phase 2 window |
